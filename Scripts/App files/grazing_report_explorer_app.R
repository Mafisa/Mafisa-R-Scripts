...
base_dir <- "C:/Users/ShidaNyimbili/OneDrive - Zayohub Zambia Limited/Files files - Data, Research, MEL/Data Analytics/R/RMafisa App/App files/App files/Input data/Input data/Grazing spatial data"
